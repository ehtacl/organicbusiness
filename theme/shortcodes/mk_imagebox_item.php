...
if($icon_type == 'video'){
  ...
  $imageboxContent .= '<div class="mk-imagebox-item-image mk-imagebox-video-preview padding-'.$image_padding.'"><a href="'.$btn_url.'"><img src="'.$preview_image.'" alt="'.$item_title.'" /></a></div>';

}
else{
  $imageboxContent .= '<div class="mk-imagebox-item-image padding-'.$image_padding.'"><a href="'.$btn_url.'"><img src="'.$item_image.'" alt="'.$item_title.'" /></a></div>';
}
if(!empty($item_title)) {
  $imageboxContent .= '<div class="mk-imagebox-item-title"><h5 style="'.$title_color.$title_font_weight.$title_text_size.'">'.$item_title.'</h5></div>';
}
...
$output .= '<div class="swiper-slide"><div id="imagebox-item-'.$id.'" class="mk-imagebox-item '.$el_class.'"><div class="item-holder"><div class="mk-imagebox-item-content" style="'.$background_color.'">'.$imageboxContent.'</div></div></div></div>';
